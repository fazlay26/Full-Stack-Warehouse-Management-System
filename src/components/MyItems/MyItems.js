                        ...
                        myItems.map(myItem =>
                            <ul key={myItem._id}>
                                <div className='border-2 p-4 m-5 rounded-lg'>
                                    <h1 className='text-center font-semibold text-white'>name:{myItem.name}</h1>
                                    <p className='text-center font-semibold text-white'>price:${myItem.price}</p>
                                    <p className='text-center font-semibold text-white'>quantity:{myItem.quantity}</p>
                                    <p className='text-center font-semibold text-white'>supplier:{myItem.supplier}</p>
