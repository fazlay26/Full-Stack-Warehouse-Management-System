...
const Blogs = () => {
    return (
        <div>
            <div className='border-solid border-2 border-orange-600 p-5 rounded-md mx-5'>
            ...
            <div className='border-solid border-2 border-orange-600 p-5 rounded-md mx-5 my-2'>
