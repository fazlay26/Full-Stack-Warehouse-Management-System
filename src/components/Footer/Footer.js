...
const Footer = () => {
    return (
        <div className=' md: bg-slate-800 mt-auto'>
            <footer className="text-center  lg:text-left  text-white mt-auto sm:min-w-full">
          ...
          ">
                            ...
                            <p>
                                Here you can find us and manage your all products.
                                we have four branch.Feel free contact us.
                            </p>
                        </div>
                        <div className="">
                ...
                <div className="text-center p-6 bg-slate-900">
                    ...
                    <a className="text-white font-semibold" href="https://tailwind-elements.com/">Bike Manager</a>
                </div>
            </footer>
        </div>
    );
